...
class NluProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "intent_detection/fewshot-10/intent_seq.in")),
                                     self._read_tsv(os.path.join(data_dir, "intent_detection/fewshot-10/intent_seq.out")), "train")
        # return self._create_examples(self._read_tsv(os.path.join(data_dir, "fewshot-10/intent_seq.in")),
        #                              self._read_tsv(os.path.join(data_dir, "fewshot-10/intent_seq.out")), "train")
...
def prepare_data(examples, max_seq_len, tokenizer, labels):
    ...
    for idx,example in enumerate(examples):
        ...
        if idx < 5:
            ...
            print('Slot_labels: %s' %instance.slot_ids)
